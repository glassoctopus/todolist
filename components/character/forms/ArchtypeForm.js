...
const initialState = {
  ...
  dexterity: '', // Need to fetch these from archtype.archetype_attributes
  knowledge: '', // Need to fetch these from archtype.archetype_attributes
  mechanical: '', // Need to fetch these from archtype.archetype_attributes
  perception: '', // Need to fetch these from archtype.archetype_attributes
  strength: '', // Need to fetch these from archtype.archetype_attributes
  technical: '', // Need to fetch these from archtype.archetype_attributes
  personality: '',
  background: '',
  objectives: '',
  a_quote: '',
